...
<tileset version="1.10" tiledversion="1.11.0" name="Terrain_Edges" tilewidth="128" tileheight="128" tilecount="20" columns="10">
 <image source="../../graphics/tilesets/terrain_edges.png" width="1280" height="256"/>
 <wangsets>
  <wangset name="Paths" type="edge" tile="-1">
   <wangcolor name="Yellow Path" color="#ff0000" tile="-1" probability="1"/>
